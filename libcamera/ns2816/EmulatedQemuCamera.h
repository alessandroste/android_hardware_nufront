 ...
 * for EmulatedQemuCameraDevice instance.
 */
 ...
 * This class is nothing more than a placeholder for EmulatedQemuCameraDevice
...
protected:
    ...
    EmulatedQemuCameraDevice    mFakeCameraDevice;
};
