...
/* Encapsulates a converter between YV12, YUYV and JPEG formats.
 */
...
/* Encapsulates a converter between NV21 with effect and JPEG formats.
 */
class NV21EffectJpegCompressor
{
public:
    /* Constructs JpegCompressor instance. */
