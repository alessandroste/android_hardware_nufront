...
public:
     ...
     *  NO_ERROR on success, or an appropriate error status.
     */
    virtual status_t startDevice(int width, int height, uint32_t pix_fmt, int effctType) = 0;
...
public:
    ...
    /* Sets the rotation info for the camera device.
     */
    virtual status_t setExifOrientationInfo(int orientationInfo);
    virtual int getExifOrientationInfo();
    ...
    void setColorEffect(int effect);

    void getNV21EffectFrame(void *NV21Frame,int width,int height);
...
protected:
     ...
     *  NO_ERROR on success, or an appropriate error status.
     */
    virtual status_t commonStartDevice(int width, int height, uint32_t pix_fmt, int effectType);
