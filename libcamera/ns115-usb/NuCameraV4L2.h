...
///////////////////////////////////////////////////////////
#ifdef CAMERA_OV2643
#define GC0329_PREVIEW_WIDTH               1280 //640
#define GC0329_PREVIEW_HEIGHT              720  //480
#define GC0329_SNAPSHOT_WIDTH              1600  //640
#define GC0329_SNAPSHOT_HEIGHT             1200  //480
#else
...
#ifdef CAMERA_OV2643
#define GC0329_THUMBNAIL_WIDTH             320  //160
#define GC0329_THUMBNAIL_HEIGHT            240  //120
#else
...
/*for usb camera*/
#define USB_PREVIEW_WIDTH            640
#define USB_PREVIEW_HEIGHT           480
#define USB_SNAPSHOT_WIDTH           640
#define USB_SNAPSHOT_HEIGHT          480

#define USB_THUMBNAIL_WIDTH          320
#define USB_THUMBNAIL_HEIGHT         240
#define USB_THUMBNAIL_BPP            16

/* focal length of 3.37mm */
#define USB_FOCAL_LENGTH             337
...
public:
    ...
    int             initCamera(NuCameraHardware *camera, int index, int size);
    void            DeinitCamera();
    void            resetCamera();
...
///////////////////////////////////////////////////////////////////////////////
    ...
    void            getPreviewFrameAddr(int index, EWLLinearMem_t *paddr) const;
    void            getCaptureFrameAddr(int index, EWLLinearMem_t *) const;
    int             readGovernor(void);
    int             writeGovernor(const char *governor);
	int 			nusmart_v4l2_querybuf(int fd,  enum v4l2_buf_type type, int index);
	int             nusmart_v4l2_enum_ctl_id(int fd); 
	int 			nusmart_v4l2_querycap(int fd);
	int             nusmart_v4l2_enum_reso(void);
	int 			USB_v4l2_enum_fmt(int fp, unsigned int fmt);
	static int      v4l2getNumberOfCameras(bool *isUsbOneCamera);
	
	NuCameraHardware *	  camera;	
	int 	              CameraSupportFmt;
	int 				  tempWhite;
...
private:
	...
	fimc_buffer           tempbuff[NUM_PREVIEW_BUFFERS];
