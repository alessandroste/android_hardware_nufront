...
// define for walle params
#define WALLE_PARAMS 1
// define for walle performance
...
////////////////////////////////////////////////////////////////////////////////
//
//       Funcs For Walle Camera
//
///////////////////////////////////////////////////////////////////////////////
	//void            gestureRecognitionPrecess(int index);
    void            bayer2NV12(void* bayer, void* nv, int w, int h, int bgr_mode);
    void            bayer2NV21(void* bayer, void* nv, int w, int h, int bgr_mode);
    void            scalingDown420SP(void*src, int srcWidth, int srcHeight,
                                    void*dst, int dstWidth, int dstHeight);
    void            scalingDown420SP_4_walle(void*src, int srcWidth, int srcHeight,
                                    void*dst, int dstWidth, int dstHeight);
    #ifdef WALLE_PARAMS
    void            setStreamSize(int width, int height);
    void            getStreamSize(int *pw, int *ph, int *psize);
    #endif
private:
    ...
    EWLLinearMem_t        m_ewl_mem_info[NUM_PREVIEW_BUFFERS+1];
    EWLLinearMem_t        m_ewl_capture_mem_info[NUM_CAPTURE_BUFFERS + 1];
