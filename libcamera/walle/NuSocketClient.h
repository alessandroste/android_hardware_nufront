#ifndef _NU_SOCKET_CLIENT_H
#define _NU_SOCKET_CLIENT_H
...
public:
    NuSocketClient(int sock, bool owned);
    virtual ~NuSocketClient();
...
typedef android::List<NuSocketClient *> NuSocketClientCollection;
#endif
