...
// number of IFD, need changed with addtion
#define NUM_0TH_IFD_TIFF            13
#define NUM_0TH_IFD_EXIF            20
...
typedef enum {
    EXIF_FLASH_OFF = 0,
    EXIF_FLASH_ON  = 1,
    EXIF_FLASH_ON_AUTO = 25,
    EXIF_FLASH_OFF_AUTO =24,
    EXIF_FLASH_NONE = 32,    //no flash function
} ExifFlashType;

/* Values */
#define EXIF_DEF_MAKER          "NUFRONT"
#define EXIF_DEF_MODEL          "NS115"
#define EXIF_DEF_SOFTWARE       "Nufront NS115 v1.0"
#define EXIF_DEF_EXIF_VERSION   "0220"
#define EXIF_DEF_USERCOMMENTS   "User comments"

#define EXIF_DEF_YCBCR_POSITIONING  1   /* centered */
#define EXIF_DEF_FNUMBER_NUM        28  /* 2.8 */
#define EXIF_DEF_FNUMBER_DEN        10
#define EXIF_DEF_EXPOSURE_PROGRAM   3   /* aperture priority */
#define EXIF_DEF_FOCAL_LEN_NUM      337 /* 3.37mm */
#define EXIF_DEF_FOCAL_LEN_DEN      100
#define EXIF_DEF_FLASH              0   /* 0: off, 1: on*/
