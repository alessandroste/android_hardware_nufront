...
//scene mode
#define V4L2_CID_CAMERA_SCENE_MODE		(V4L2_CID_PRIVATE_BASE + 128)
...
//flash mode
#define V4L2_CID_CAMERA_FLASH_MODE		(V4L2_CID_PRIVATE_BASE + 129)
...
#define V4L2_CID_WALLE_BGRG_MODE      (V4L2_CID_PRIVATE_BASE + 152)
/*
