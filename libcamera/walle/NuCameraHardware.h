...
enum command_list{
    CMD_NONE,
    CMD_WALLE_MODE,  //WALLE relative commands
    CMD_MAX,
};

enum walle_state{
    WALLE_3THRD_GESTURE, //support 3Thrd app and gesture recognition
    WALLE_GESTURE,  //only support gesture recognition func
	WALLE_AUTO_CALIBRATE, //only support auto calibrate func
};
///////////////////////////////////////////////////////////////////////
//
