...
typedef struct decContainer
{
    ...
    u32 seekFlag; /*a@nufront*/
    u32 previewImageFlag; /* a@nufront: Preview image flag  */
    i32 firstISlicePicID; /* a@nufront: Number of reference frame */
    u32 memAllocStat; /*a@nufront: decoder  memory allocation state*/
} decContainer_t;
