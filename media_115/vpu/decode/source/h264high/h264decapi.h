...
#include "legacy/h264hwd_slice_header.h" /*a@nufront*/
...
------------------------------------------------------------------------------*/
    ...
    typedef struct H264DecPicture_
    {
        ...
        u32 numRefFrames;    /* a@nufront: Number of reference frame */
        i32 firstISlicePicID;/* a@nufront: The first I slice in stream */
        u32 viewId;
    ...
    /*m@nufront*/
    typedef struct H264DecLinearMem_
    {
        u32 *virtualAddress;
        u32 busAddress;
        u32 size;
...
------------------------------------------------------------------------------*/
    ...
    H264DecRet H264DecInit(H264DecInst * pDecInst, u32 noOutputReordering,
                           ...
                           u32 previewImageFlag /* a@nufront */);
...
/*m@nufont*/
    H264DecRet H264DecMallocLinear(H264DecInst decInst,u32 size,H264DecLinearMem *info);
    H264DecRet H264DecFreeLinear(H264DecInst decInst, H264DecLinearMem * info);

    /*a@nufront: be called in when seeking */
    void H264DecSeeKReconfig(H264DecInst decInst);
/*------------------------------------------------------------------------------
