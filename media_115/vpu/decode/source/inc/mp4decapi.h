...
------------------------------------------------------------------------------*/
	...
	/*a@nufront start*/
	typedef struct MP4DecLinearMemInfo_
	{
		u32 *virtualAddress;
		u32 busAddress;
		u32 size;
...
------------------------------------------------------------------------------*/
    ...
    MP4DecRet MP4DecPeek(MP4DecInst        decInst,
                         MP4DecPicture    *pPicture);
    /* a@nufront start */
    MP4DecRet MP4DecMallocLinear(MP4DecInst          decInst,
                                 u32                 size,
                                 MP4DecLinearMemInfo * info);

    MP4DecRet MP4DecFreeLinear(MP4DecInst          decInst,
                               MP4DecLinearMemInfo * info);
    /**a@nufront: be called in when seeking */
    void MP4DecSeeKReconfig(MP4DecInst decInst);
    /* a@nufront end */
/*------------------------------------------------------------------------------
