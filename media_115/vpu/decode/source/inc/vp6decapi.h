...
------------------------------------------------------------------------------*/
	...
	/* a@nufront start */
    VP6DecRet VP6DecMallocLinear(VP6DecInst decInst,u32 size,VP6DecLinearMemInfo *info);

    VP6DecRet VP6DecFreeLinear(VP6DecInst decInst, VP6DecLinearMemInfo * info);
	/* a@nufront end */
/*------------------------------------------------------------------------------
