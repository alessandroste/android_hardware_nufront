...
------------------------------------------------------------------------------*/
    ...
    /*a@nufront start: Linear memory area descriptor */
    typedef struct
    {
        u32 *virtualAddress;
        u32 busAddress;
        u32 size;
    } Mpeg2DecLinearMemInfo;
    /*a@nufront end*/
...
------------------------------------------------------------------------------*/
	...
	/*a@nufront start */
    Mpeg2DecRet Mpeg2DecMallocLinear(Mpeg2DecInst decInst, u32 size, Mpeg2DecLinearMemInfo* info);

    Mpeg2DecRet Mpeg2DecFreeLinear(Mpeg2DecInst decInst,Mpeg2DecLinearMemInfo *info);

    void MP2DecSeeKReconfig(Mpeg2DecInst decInst);
    /*a@nufront end */
/*------------------------------------------------------------------------------
