...
/* Decode JFIF */
    ...
    /* a@nufront start */
    JpegDecRet JpegDecMallocLinear(JpegDecInst decInst,u32 size,JpegDecLinearMem *info);

    JpegDecRet JpegDecFreeLinear(JpegDecInst decInst, JpegDecLinearMem * info);
    /* a@nufront end */
