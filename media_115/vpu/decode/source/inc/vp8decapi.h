...
------------------------------------------------------------------------------*/
    ...
    /* a@nufront start */
    VP8DecRet VP8DecMallocLinear(VP8DecInst decInst,u32 size,VP8DecLinearMemInfo *info);

    VP8DecRet VP8DecFreeLinear(VP8DecInst decInst, VP8DecLinearMemInfo * info);
    /* a@nufront end */
