...
/*m@nufront*/
    ...
    typedef u32 RvCustomMessage_ID;

    typedef struct
    {
        RvCustomMessage_ID message_id;
        u32 num_sizes;
        u32 *sizes;
    } RvMsgSetDecoderRprSizes;
...
------------------------------------------------------------------------------*/
 ...
 /*m@nufront*/
    RvDecRet RvDecCustomMessage(void *msg_id, void *decInst);
    RvDecRet RvDecMallocLinear(RvDecInst decInst, u32 size, RvDecLinearMem *info);
    RvDecRet RvDecFreeLinear(RvDecInst decInst, RvDecLinearMem *info);
