...
------------------------------------------------------------------------------*/
    ...
    */
    ...
    /* a@nufront: Linear memory area descriptor */
    typedef struct
    {
        u32 *virtualAddress;
        u32 busAddress;
...
------------------------------------------------------------------------------*/
    ...
    /* a@nufront start */
    VC1DecRet VC1DecMallocLinear(VC1DecInst decInst, u32 size, VC1DecLinearMemInfo* info);

    VC1DecRet VC1DecFreeLinear(VC1DecInst decInst, VC1DecLinearMemInfo *info);

    void VC1DecSeeKReconfig(VC1DecInst decInst);
    /* a@nufront end */
/*------------------------------------------------------------------------------
