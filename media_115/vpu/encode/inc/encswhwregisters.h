...
/* JPEG / VP8 mixed definitions regs 0x100-0x17C */
    ...
    {HEncVp8CostInter        , 0x280, 0x00000fff,  0, 1, "VP8 bit cost of inter type"},
    {HEncVp8DmvCostConst     , 0x280, 0x00fff000, 12, 1, "VP8 coeff for dmv penalty for intra/inter selection"},
    {HEncVp8CostGoldenRef    , 0x284, 0x00000fff,  0, 1, "VP8 bit cost of golden ref frame"},
    {HEncVp8LfRefDelta0      , 0x288, 0x0000007f,  0, 1, "VP8 loop filter delta for intra mb"},
    {HEncVp8LfRefDelta1      , 0x288, 0x00003f80,  7, 1, "VP8 loop filter delta for last ref"},
    {HEncVp8LfRefDelta2      , 0x288, 0x001fc000, 14, 1, "VP8 loop filter delta for golden ref"},
    {HEncVp8LfRefDelta3      , 0x288, 0x0fe00000, 21, 1, "VP8 loop filter delta for alt ref"},
    {HEncVp8LfModeDelta0     , 0x28C, 0x0000007f,  0, 1, "VP8 loop filter delta for BPRED"},
    {HEncVp8LfModeDelta1     , 0x28C, 0x00003f80,  7, 1, "VP8 loop filter delta for ZEROMV"},
    {HEncVp8LfModeDelta2     , 0x28C, 0x001fc000, 14, 1, "VP8 loop filter delta for NEWMV"},
    {HEncVp8LfModeDelta3     , 0x28C, 0x0fe00000, 21, 1, "VP8 loop filter delta for SPLITMV"}
