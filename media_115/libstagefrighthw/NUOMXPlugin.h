...
#ifndef NU_OMX_PLUGIN_H_

#define NU_OMX_PLUGIN_H_

#include <media/hardware/OMXPluginBase.h>

namespace android {

struct NUOMXPlugin : public OMXPluginBase {
    NUOMXPlugin();
    virtual ~NUOMXPlugin();
...
private:
    ...
    NUOMXPlugin(const NUOMXPlugin &);
    NUOMXPlugin &operator=(const NUOMXPlugin &);
};

}  // namespace android

#endif  // NU_OMX_PLUGIN_H_
