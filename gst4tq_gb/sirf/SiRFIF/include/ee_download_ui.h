 ...
 ***************************************************************************
 *
 * MODULE:  SiRFInstantFix
 *
 * FILENAME: ee_download_ui.h
 *
 * DESCRIPTION:  CLM API Interface file
 *
 *
 ***************************************************************************
 *
 ...
 *
 *  $File: //customs/customer/Marvell-U1/sirf/Software/sirf/SiRFIF/include/ee_download_ui.h $
 *
...
typedef enum {
    ...
    EE_DOWNLOAD_WAIT_STR_CMP,                   /* Indicates actual storage write is still not completed */
    EE_DOWNLOAD_GET_URID_FAILED,                /* EE Downloader GET URID failure successfully */
    EE_DOWNLOAD_NO_URID_INFO,                   /* EE Downloader has no/invalid URID Info i.e. OEM ID and DEVICE ID */
...
#define CLM_DLOG_SEVERITY_LEVEL_MAX       3
#define CLM_DLOG_SEVERITY_LEVEL_2         2
#define CLM_DLOG_SEVERITY_LEVEL_1         1
#define CLM_DLOG_SEVERITY_LEVEL_MIN       0
...
#define SGEE_SERVER_AUTH_STRING_SIZE 256
#define SGEE_SERVER_FILE_STRING_SIZE 256
...
/* EE Downloader cofiguration parameters */
typedef struct
{
    tSIRF_CHAR   pServerAddress[2][ADDRESS_STRING_SIZE];
    tSIRF_UINT16 serverPort;
    tSIRF_CHAR   *pServerFile;
    tSIRF_CHAR   *pServerAuth;
    tSIRF_UINT8 OTAFormat;
#ifdef USE_URID 
    tSIRF_BOOL uridInfoValidFlag;
    tSIRF_UINT8  uridOemSubId[OEM_SUB_ID_SIZE];
    tSIRF_UINT8 uridDeviceId[DEVICE_ID_SIZE];
#endif  
}tEE_DOWNLOAD_CONFIG;
...
tEE_DOWNLOAD_STATUS EE_Download_Init(
    tEE_DOWNLOAD_CONFIG *pEEDownloadConfig);
