 ...
 *
 *  Archive:$File: //customs/customer/Marvell-U1/sirf/Software/sirf/SiRFIF/include/clm_main/clm_structs.h $
 *
...
#define MAX_EPHEMERIS_DAYS_IN_STORAGE       7
...
typedef struct{
    /*CLM operation mode*/
    tSIRF_UINT8 operationMode;  /*(0: SGEE mode, 1: CGEE, 2: SGEE-CGEE)*/
    ...
    tSIRF_UINT8 cgeeInputMethod;    /*0: Unknown, 1: BE and Ionosphere data, 2: Sub frame data*/
...
typedef struct{
   ...
   tSIRF_UINT32   satPredictedMask;            /* Satellites predicted since start up */
} tCLM_CGEE_STATUS;
